    ...
    <>
      <main className="flex flex-col pb-3">
        <header className="animate__bounceIn flex flex-col items-center w-full pb-6 text-white">
          <h1 className="text-2xl">SANDY</h1>
          <h2 className="text-2xl font-bold">English Class Minigame</h2>
          <h3 className="text-base">Created by Sandeep Prajapati</h3>
          <ul className="flex">
            <li className="mr-2">
              <a href="https://www.github.com/sandyp007" title="Github profile">
                <i className="bi bi-github"></i>
              </a>
            </li>
            <li>
              <a href="mailto:prajapatisan7@gmail.com" title="Send email">
